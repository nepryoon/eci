...
| Tombstone/delete end-to-end | ADD M1 §§1.6.4–1.6.6, 2.2; event schema `DELETE`; ADR-0025; SPEC-070/071 | ingestion, PG/outbox/CDC, 3 sink, cache, summary, reconcile | canonical DELETE autenticata implementata: receipt e node/relation/chunk/embedding tombstone ACID, FK cleanup, replay/conflict, no MinIO/parser; envelope condiviso allineato ai quattro aggregate; Compose/Helm CDC promuovono l'operazione canonica in header minimale | esecuzione PostgreSQL/CDC bloccata dal daemon; sink DELETE e invalidazioni/reconciliation restano | ACID/replay/idempotenza/failure/cross-tenant integration, CDC header reale, poi consumer effect-before-marker | scope solo da header; delete selezionata per tenant/repo/ACL/path; tombstone senza source/vector; operation header chiuso; marker dopo effetto | SPEC-070/071 implementate; projection SPEC successive | in_progress | canonical red/feature `70cb799`/`4ad4c08`; CDC red/feature `eb20670`/`1cbf12c`; CPU gates, CDC compile e K8s validate PASS; integration Docker bloccata |

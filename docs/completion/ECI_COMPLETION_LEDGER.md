...
| Tombstone/delete end-to-end | ADD M1 §§1.6.4–1.6.6, 2.2; event schema `DELETE`; ADR-0025; SPEC-070–075 | ingestion, PG/outbox/CDC, shared Go metadata, embedding worker, 3 sink, cache, summary, reconcile | canonical DELETE/CDC/parser; sink-graph scoped deletion; embedding-worker delete acknowledgement; sink-vector Qdrant Delete(wait=true) con filtro point ID + tenant/repo/ACL, marker post-Completed e replay assente idempotente | esecuzione Docker-backed bloccata; OpenSearch DELETE e invalidazioni/reconciliation restano | ACID/replay/idempotenza/failure/cross-tenant integration, CDC header reale, projection consumers | metadata non-disclosing; graph/Qdrant scope gates; delete non ricrea dati; marker post-effetto | SPEC-070/071/073/074/075 implemented, SPEC-072 verified; search/invalidation SPEC successive | in_progress | vector red/integration/feature `8bf7435`/`2f2a328`/`dc6dcbe`; unit/race/vet, integration compile, build/lint/test/security PASS; Docker blocked |

...
| Tombstone/delete end-to-end | ADD M1 §§1.6.4–1.6.6, 2.2; event schema `DELETE`; ADR-0025; SPEC-070–072 | ingestion, PG/outbox/CDC, shared Go metadata, 3 sink, cache, summary, reconcile | canonical DELETE autenticata implementata; envelope condiviso allineato ai quattro aggregate; Compose/Helm CDC promuovono operation minimale; parser Go fail-closed verifica event ID/operation singoli e canonici | esecuzione PostgreSQL/CDC bloccata dal daemon; sink DELETE e invalidazioni/reconciliation restano | ACID/replay/idempotenza/failure/cross-tenant integration, CDC header reale, poi consumer effect-before-marker | scope solo da header; tombstone senza source/vector; operation header chiuso e parser non-disclosing; marker dopo effetto | SPEC-070/071 implementate, SPEC-072 verified; projection SPEC successive | in_progress | canonical `70cb799`/`4ad4c08`; CDC `eb20670`/`1cbf12c`; metadata `0f7c2bd`/`e039d86`; CPU gates + 263k fuzz executions PASS; Docker bloccato |

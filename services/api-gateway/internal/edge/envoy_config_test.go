...
func TestEnvoyConfigurationPreservesSecurityFilterOrderAndStrictness(t *testing.T) {
	...
	for _, required := range []string{
		...
		"remove: tracestate",
		"remove: baggage",
		"remove: x-eci-request-deadline-unix-ms",
		...
		"key: remote_address",
		"remote_address: {}",
		"always_consume_default_token_bucket: true",
		"failure_mode_allow: false",
		"max_request_bytes: 1048576",
		"reject_unknown_method: true",
		"ignore_unknown_query_parameters: false",
		"eci.retrieval.v1.RetrievalEngine",
		"path: /eci.retrieval.v1.RetrievalEngine/ImpactAnalysis",
		"cluster: retrieval_engine_stream",
		`regex: ^/eci\.retrieval\.v1\.RetrievalEngine/(HybridSearch|GetNode|ExpandNeighbors)$`,
		"max_requests: 100",
		"key: retry-after",
		"address: 127.0.0.1",
		"timeout: 0s",

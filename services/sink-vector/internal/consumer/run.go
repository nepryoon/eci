...
// un errore di `process` (Postgres/Qdrant irraggiungibile) NON committa
// l'offset — il messaggio verrà riconsegnato al prossimo poll. Apre uno
// span per messaggio processato (§8), collegato via span link al trace
// del produttore quando l'header trace_id è presente e valido — stesso
// pattern di sink-graph/embedding-worker (SPEC-011/015/030).
//

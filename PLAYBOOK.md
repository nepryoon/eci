...
| T7.1c | Verification e summarization runtime: API autenticate long-running, probe e graceful shutdown reali | T7.1 | 🔴 |
| T7.2 | Autoscaling: HPA CPU parsing, KEDA Kafka lag sui sink, KEDA num_requests_waiting su vLLM | T7.1a | 🟡 |
| T7.3 | OTel end-to-end (span links Kafka, gen_ai.*) + dashboard Grafana + alert | T7.1b, T7.1c | 🟢 |
